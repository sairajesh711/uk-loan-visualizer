...
const elReturnValue = $("#returnValue");
...
const outDeltaVsOverpay = $("#result-deltaVsOverpay");
const outBreakEvenReturn = $("#result-breakEvenReturn");
...
function readInputs() {
  ...
  const expectedReturn = clamp(Number(elExpectedReturn.value || 5), 0, 50);
  ...
  if (Number(elExpectedReturn.value) !== expectedReturn) elExpectedReturn.value = String(expectedReturn);
